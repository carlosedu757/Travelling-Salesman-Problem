...
### Média Final Programação Dinâmica (Held-Karp)
...
### Média Final Algoritmo Guloso (Vizinho mais próximo)
...
| Quantidade de pontos | Tempo Gasto |
| -------------------- | ----------- |
| 4 | 0.00000000 |
| 6 | 0.00000000 |
| 8 | 0.00000000 |
...
### Média Final Programação Dinâmica (Euclidiano Bitônico)
